export const experienceData = {
  ...
  timeline: [
    {
      ...
      contributions: [
        "Developed a Model to generate synthetic Health Records",
        "Worked on creating Virtual Patient",
        "Implement the custom module for Graph to Graph Generation",
      ],
      technologies: [
        "Python",
        "Knowledge Graph",
  ...
  growthMetrics: [
    ...
    { label: "Team Collaboration", value: 90, color: "bg-blue-500" },
    { label: "Problem Solving", value: 95, color: "bg-orange-500" },
  ],
  ctaText: "Ready to leverage my skills for impactful projects!",
  ctaButton: "Let's Connect & Create",
};
